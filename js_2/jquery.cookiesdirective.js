...
;(function($) {
	...
	var disclosure = function(options) {
		...
		if(settings.explicitConsent) {
			...
			html += settings.explicitFindOutMore + '<a rel="shadowbox;width=900;height=600;" style="color:'+ settings.linkColor + ';font-weight:bold;';
			...
			html += scriptsDisclosure + settings.impliedDisclosureText + ' <a rel="shadowbox;width=900;height=600;" style="color:'+ settings.linkColor + ';';
			...
			html += '<div style="margin-top:5px;color: #000;';
			if(settings.inlineAction) {
				html += 'display:inline-block;margin-left:5px';
			}

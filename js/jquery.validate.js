...
$.extend( $.validator, {
	...
	messages: {
		...
		url: "Por favor ingresa una dirección web válida.",
		date: "Por favor ingresa una fecha válida.",
		dateISO: "Please enter a valid date (ISO).",
		number: "Por favor ingresa un número válido.",
		digits: "Por favor ingresa solo dígitos.",
		equalTo: "Por favor ingresa el mismo valor nuevamente.",
		maxlength: $.validator.format( "Por favor ingresa un maximo de {0} caracteres." ),
		minlength: $.validator.format( "Por favor ingresa al menos {0} caracteres." ),
		rangelength: $.validator.format( "Por favor ingresa entre {0} y {1} caracteres." ),
